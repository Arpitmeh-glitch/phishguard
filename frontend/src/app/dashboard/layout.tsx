  ...
  return (
    ...
    <html lang="en">
      <head>
        ...
        {/*
         * FIX: Added Syne (wght 700;800;900) — required by the About page for
         * all section headings, the hero title, creator name, and footer logo.
         * Without it the browser falls back to system-ui which breaks the
         * tight tracked display aesthetic used throughout /about.
         *
         * JetBrains Mono, Space Grotesk, and Inter are unchanged from before.
         */}
        <link
          href="https://fonts.googleapis.com/css2?family=JetBrains+Mono:wght@300;400;500;600&family=Space+Grotesk:wght@300;400;500;600;700&family=Inter:wght@300;400;500;600&family=Syne:wght@700;800;900&display=swap"
          rel="stylesheet"
        />
      </head>

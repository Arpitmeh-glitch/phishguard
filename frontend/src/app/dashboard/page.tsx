    ...
    <div className="cyber-card p-5">
      <div className="flex items-start justify-between mb-4">
        <div
          ...
          style={{ background: `color-mix(in srgb, ${c} 8%, transparent)`, borderColor: `color-mix(in srgb, ${c} 25%, transparent)` }}
        >
      ...
      {sublabel && <div className="text-xs mt-1" style={{ color: "#8892b0", opacity: 0.6 }}>{sublabel}</div>}
    </div>
  );
}
    ...
    <div className="p-8">
      ...
      <div className="mb-8">
        <div className="flex items-center gap-2 mb-1">
          ...
          <span className="font-mono text-xs uppercase tracking-widest" style={{ color: "var(--neon-cyan)" }}>
            Live Dashboard
          </span>
        </div>
      ...
      <div className="grid lg:grid-cols-3 gap-6 mb-8">
        ...
        <div className="cyber-card p-5">
          <div className="mb-4">
            <h2 className="font-display font-semibold text-sm" style={{ color: "#e8eaf0" }}>Scan Breakdown</h2>
          ...
          {pieData.some((d) => d.value > 0) ? (
            ...
            <div className="flex items-center justify-center h-36 text-xs font-mono" style={{ color: "#8892b0" }}>
              No data yet
            </div>
          )}
        </div>
      ...
      {/* Scan type breakdown */}
      {/*
       * FIX: Changed <a href> to <Link href> for proper SPA routing.
       * <a> tags cause full page reloads; Next.js Link enables client navigation.
       */}
        ...
        {[
          ...
          >
            ...
            <div>
              ...
              <div className="text-xs font-mono" style={{ color: "#8892b0" }}>{item.label}</div>
            </div>
            <div className="ml-auto transition-colors" style={{ color: "#8892b0" }}>→</div>
          </Link>
        ))}
      </div>
    </div>
